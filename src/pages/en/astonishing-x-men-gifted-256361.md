...
type: movie
logo_on_black: "{fanart-path}/astonishing-x-men-gifted-5e70532739927.png"
---
## TMDB Data
```json
{
    ...
    "overview": "Cyclops and Emma Frost re-form the X-Men with the express purpose of \"astonishing\" the world. But when breaking news regarding a cure to the mutant gene unexpectedly hits the airwaves, will it derail their new plans before they even get started?",
