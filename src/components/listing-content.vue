<template>
    <div class="flex flex-col items-start gap-8">
        ...
        <div class="credits opacity-50">
            ...
            >
                Timeline Order data via <a class="underline" href="https://docs.google.com/spreadsheets/d/1Xfe--9Wshbb3ru0JplA2PnEwN7mVawazKmhWJjr_wKs/edit#gid=0">r/MarvelStudios MCU Viewing</a>
            </div>
        </div>
        ...
        <span class="relative z-0 inline-flex text-center md:flex-row flex-col shadow-sm md:divide-x md:divide-y-0 divide-y divide-gray-700 border border-gray-300 rounded-md bg-black/50 md:py-3 md:px-0 px-4">
            ...
            >
                ...
                >
                    <div
                        class="inner-link hover:bg-indigo-400 active:bg-indigo-600 rounded-md px-4 md:py-2 md:mx-0 md:-my-3 py-3 -mx-4" :class="[
                            i !== 0 ? 'md:-ml-px' : '',
                            // Last Link
